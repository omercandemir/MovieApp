				...
				<div class="movie-img sticky-sb">
					...
					<div class="movie-btn">	
						<div class="btn-transform transform-vertical red">
							...
							<div><a href="https://www.youtube.com/embed/<?php if(empty($movieDetail['videos']['results'])){ } else{ echo $movieDetail['videos']['results'][0]['key']; } ?>" class="item item-2 redbtn fancybox-media hvr-grow"><i class="ion-play"></i></a></div>
						</div>
