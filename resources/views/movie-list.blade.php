...
<div class="hero common-hero" style="background-size: cover;">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="hero-ct">
					<h1> {{ucfirst(Request::segment(2))}} Movies</h1>
					<ul class="breadcumb">
						<li class="active"><a href="{{url('/')}}">Home</a></li>
						<li> <span class="ion-ios-arrow-right"></span>{{Request::segment(2)}} movies</li>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row ipad-width">
			<div class="topbar-filter">
				<p>Found <span>100 {{Request::segment(2)}} movies</span> in total</p>
			</div>
